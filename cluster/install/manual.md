...
1. Required to be running on the nodes before they can be added to the cluster. CRI. 

2. Install and configure prerequisites: [Container Runtimes | Kubernetes.](https://kubernetes.io/docs/setup/production-environment/container-runtimes/)
...
3. [Installation of containerd Runtime](https://github.com/containerd/containerd/blob/main/docs/getting-started.md)
...
https://raw.githubusercontent.com/containerd/containerd/main/containerd.service into `/usr/local/lib/systemd/system/containerd.service` or `/lib/systemd/system/containerd.service` for ubuntu,
...
4. Install kubelet, kubeadm and kubectl, and enable kubelet to ensure it's automatically started on startup:
```
sudo apt-get update
